#ifndef ompOddEvenSortV1_hpp
#define ompOddEvenSortV1_hpp
...
namespace sorting {
  ...
  /**
   * Implémentation OpenMP de l'algorithme de tri odd-even sort. La stratégie de
   * parallélisation utilisée consiste à maximiser la région parallèle en lui
   * faisant incorporer la boucle extérieure.
   *
  ...
  static void ompOddEvenSortV1(const RandomAccessIterator& first,
    ...
    // ci-dessus.
    return ompOddEvenSortV1(first, last, std::less< const value_type& >());
